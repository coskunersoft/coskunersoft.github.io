...
var ASM_CONSTS = {
  4374216: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4374271: ($0) => { performance.now = function() { return $0; }; },  
 4374319: ($0) => { performance.now = function() { return $0; }; },  
 4374367: () => { performance.now = Module['emscripten_get_now_backup']; }
};
...
// end include: preamble.js
  ...
  function _RequestTelegramUserData() {
          if (window.Telegram && Telegram.WebApp) {
              const user = Telegram.WebApp.initDataUnsafe.user; // JS'te profil bilgisi
              const data = JSON.stringify(user);
  
              // unityInstanceRef varsa direkt sahnedeki GameObject'e mesaj gönder
              if (typeof unityInstanceRef !== 'undefined') {
                  unityInstanceRef.SendMessage('LoggerObject', 'OnTelegramUserData', data);
              } else {
                  console.warn("Unity instance henüz hazır değil.");
              }
          } else {
